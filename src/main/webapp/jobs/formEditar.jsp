        ...
        <div class='container'>
            <div class="row justify-content-center">
                <div class="col-md-6 col-sm-12 col-lg-4">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/JobServlet?action=actualizar">
                        <input type="hidden" name="jobId" value="<%=job.getJobId()%>">
                        <div class="mb-3">
                            <label for="jobTitle" class="form-label">job title</label>
                            <input type="text" class="form-control" id="jobTitle" placeholder="job title"
                                   name="jobTitle" value="<%=job.getJobTitle()%>">
                        </div>
                        <div class="mb-3">
                            <label for="minSalary" class="form-label">Min salary</label>
                            <input type="text" class="form-control" id="minSalary" placeholder="min salary"
                                   name="minSalary" value="<%=job.getMinSalary()%>">
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="maxSalary" placeholder="max salary"
                                   name="maxSalary" value="<%=job.getMaxSalary()%>">
                        </div>
